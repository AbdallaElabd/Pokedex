 ...
 */
export const generateCssVariables = (theme: Theme, prefix = ''): string[] => Object.entries(theme).reduce<string[]>((cssVariables, [key, value]) => {
...
export const generateCssGetters = (
  theme: NestedObject,
  prefix = '',
): NestedObject => Object.entries(theme).reduce<NestedObject>(
